...
export const cryptoAssets: MarketAsset[] = [
  { symbol: 'BTC', name: 'Bitcoin', price: generatePrice(43250), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/1/large/bitcoin.png' },
  { symbol: 'ETH', name: 'Ethereum', price: generatePrice(2580), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/279/large/ethereum.png' },
  { symbol: 'BNB', name: 'BNB', price: generatePrice(315), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/825/large/bnb-icon2_2x.png' },
  { symbol: 'SOL', name: 'Solana', price: generatePrice(98), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/4128/large/solana.png' },
  { symbol: 'XRP', name: 'XRP', price: generatePrice(0.52), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/44/large/xrp-symbol-white-128.png' },
  { symbol: 'ADA', name: 'Cardano', price: generatePrice(0.38), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/975/large/cardano.png' },
  { symbol: 'AVAX', name: 'Avalanche', price: generatePrice(35.6), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/12559/large/Avalanche_Circle_RedWhite_Trans.png' },
  { symbol: 'DOGE', name: 'Dogecoin', price: generatePrice(0.085), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/5/large/dogecoin.png' },
  { symbol: 'DOT', name: 'Polkadot', price: generatePrice(7.85), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/12171/large/polkadot.png' },
  { symbol: 'MATIC', name: 'Polygon', price: generatePrice(0.89), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/4713/large/matic-token-icon.png' },
  { symbol: 'SHIB', name: 'Shiba Inu', price: generatePrice(0.000009), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/11939/large/shiba.png' },
  { symbol: 'TRX', name: 'TRON', price: generatePrice(0.105), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/1094/large/tron-logo.png' },
  { symbol: 'LTC', name: 'Litecoin', price: generatePrice(72.5), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/2/large/litecoin.png' },
  { symbol: 'LINK', name: 'Chainlink', price: generatePrice(14.8), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/877/large/chainlink-new-logo.png' },
  { symbol: 'UNI', name: 'Uniswap', price: generatePrice(6.2), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/12504/large/uniswap-uni.png' },
  { symbol: 'ATOM', name: 'Cosmos', price: generatePrice(9.8), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/1481/large/cosmos_hub.png' },
  { symbol: 'XLM', name: 'Stellar', price: generatePrice(0.125), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/100/large/Stellar_symbol_black_RGB.png' },
  { symbol: 'XMR', name: 'Monero', price: generatePrice(168), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/69/large/monero_logo.png' },
  { symbol: 'ETC', name: 'Ethereum Classic', price: generatePrice(20.5), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/453/large/ethereum-classic-logo.png' },
  { symbol: 'BCH', name: 'Bitcoin Cash', price: generatePrice(245), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/780/large/bitcoin-cash-circle.png' },
  { symbol: 'ALGO', name: 'Algorand', price: generatePrice(0.18), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/4380/large/download.png' },
  { symbol: 'VET', name: 'VeChain', price: generatePrice(0.025), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/1077/large/vet.png' },
  { symbol: 'FIL', name: 'Filecoin', price: generatePrice(5.2), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/12817/large/filecoin.png' },
  { symbol: 'ICP', name: 'Internet Computer', price: generatePrice(4.8), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/14495/large/Internet_Computer_logo.png' },
  { symbol: 'NEAR', name: 'NEAR Protocol', price: generatePrice(2.1), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/10365/large/near.jpg' },
  { symbol: 'APT', name: 'Aptos', price: generatePrice(8.5), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/26455/large/aptos_round.png' },
  { symbol: 'HBAR', name: 'Hedera', price: generatePrice(0.058), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/3688/large/hbar.png' },
  { symbol: 'QNT', name: 'Quant', price: generatePrice(98), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/3370/large/5ZjZKNpgxRE_NrUpRhIJ_yaaKLfWZOQX6dUHO7dW.png' },
  { symbol: 'LDO', name: 'Lido DAO', price: generatePrice(1.8), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/13573/large/Lido_DAO.png' },
  { symbol: 'STX', name: 'Stacks', price: generatePrice(0.88), change: generateChange(), type: 'crypto', logo: 'https://assets.coingecko.com/coins/images/2069/large/Stacks_logo_full.png' },
];

// Top stocks from major indices with realistic data
export const stockAssets: MarketAsset[] = [
  // Major ETFs
  { symbol: 'SPY', name: 'SPDR S&P 500 ETF Trust', price: generatePrice(458.30), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://assets.website-files.com/644c76b4b66d8ff13d426ce5/644c76b4b66d8ff13d426e84_iShares-SPY-600.jpg' },
  { symbol: 'QQQ', name: 'Invesco QQQ Trust', price: generatePrice(385.20), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.invesco.com/content/dam/invesco/global/en/images/web-logos/invesco-qqq-logo-2022.png' },
  { symbol: 'IWM', name: 'iShares Russell 2000 ETF', price: generatePrice(195.75), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.blackrock.com/content/dam/blackrock-com/shared-assets/brand/blackrock-logo.png' },
  { symbol: 'EFA', name: 'iShares MSCI EAFE ETF', price: generatePrice(72.85), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.blackrock.com/content/dam/blackrock-com/shared-assets/brand/blackrock-logo.png' },
  { symbol: 'VTI', name: 'Vanguard Total Stock Market ETF', price: generatePrice(235.60), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/The_Vanguard_Group_logo.svg' },
  { symbol: 'VEA', name: 'Vanguard FTSE Developed Markets ETF', price: generatePrice(48.25), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/The_Vanguard_Group_logo.svg' },
  { symbol: 'VOO', name: 'Vanguard S&P 500 ETF', price: generatePrice(415.90), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/The_Vanguard_Group_logo.svg' },
  { symbol: 'VWO', name: 'Vanguard Emerging Markets ETF', price: generatePrice(42.15), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/The_Vanguard_Group_logo.svg' },
  { symbol: 'GLD', name: 'SPDR Gold Trust', price: generatePrice(185.40), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.spdrs.com/content/dam/spdrs/spdrs-nav/logo_GLD.png' },
  { symbol: 'SLV', name: 'iShares Silver Trust', price: generatePrice(23.75), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.blackrock.com/content/dam/blackrock-com/shared-assets/brand/blackrock-logo.png' },
  ...
  { symbol: 'RSP', name: 'Invesco S&P 500 Equal Weight ETF', price: generatePrice(162.45), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.invesco.com/content/dam/invesco/global/en/images/web-logos/invesco-logo-2022.png' },
  { symbol: 'SCHD', name: 'Schwab US Dividend Equity ETF', price: generatePrice(78.60), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://www.schwab.com/content/dam/schwabone/shared-assets/images/logos/schwab-black-logotype.svg' },
  ...
  { symbol: 'ARKK', name: 'ARK Innovation ETF', price: generatePrice(48.60), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://ark-invest.com/wp-content/uploads/2021/03/ARK-Invest-Logo-2.png' },
  { symbol: 'ARKQ', name: 'ARK Autonomous Technology & Robotics ETF', price: generatePrice(58.45), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://ark-invest.com/wp-content/uploads/2021/03/ARK-Invest-Logo-2.png' },
  { symbol: 'ARKW', name: 'ARK Next Generation Internet ETF', price: generatePrice(82.30), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://ark-invest.com/wp-content/uploads/2021/03/ARK-Invest-Logo-2.png' },
  { symbol: 'ARKG', name: 'ARK Genomics Revolution ETF', price: generatePrice(28.75), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://ark-invest.com/wp-content/uploads/2021/03/ARK-Invest-Logo-2.png' },
  { symbol: 'ARKF', name: 'ARK Fintech Innovation ETF', price: generatePrice(18.90), change: generateChange(), type: 'stock', sector: 'ETF', logo: 'https://ark-invest.com/wp-content/uploads/2021/03/ARK-Invest-Logo-2.png' },
...
const generateAdditionalCryptos = (): MarketAsset[] => {
  ...
  return additionalCryptos.map((symbol, index) => ({
    ...
    logo: `https://assets.coingecko.com/coins/images/${1000 + index}/large/${symbol.toLowerCase()}.png`
  }));
};
